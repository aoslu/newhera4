from newheraapp.forms import MessageForm
from django.shortcuts import render
from newheraapp.models import NargileKomuru, Photo,BriketKomur,PresSosisMangalKuru, NakliyeFoto,MeseKomur, Urunler
